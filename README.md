...
Браузерная idle/tycoon-игра на React и TypeScript. Базовые производственные цепочки:

```text
деньги → картофельная ферма → картошка → завод чипсов → чипсы → деньги
деньги → апельсиновая роща → апельсины → соковый завод → апельсиновый сок → деньги
```
